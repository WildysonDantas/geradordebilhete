...
<head>
    ...
    <title>Dashboard - Gerador de Bilhete</title>
</head>

<body>
    @include('components.nav')
    <section class="mb-4 login.container">
                ...
                <div class="col-md-8 col-lg-6 col-xl-4 offset-xl-1">
                    <form method="GET" action="{{ route('gerar-bilhete') }}">
                        ...
                        <div class="form-outline mb-3">
                            ...
                            <small class="text-danger">*Os números informados serão gerados aleatoriamente e não
                                serão repetidos de acordo com os campos informados</small>
